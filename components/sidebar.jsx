      ...
      <div>
	    ...
	    className={expand? "w-36":"w-10"}
          ...
          <div onClick={()=>expand?setExpand(false):setExpand(true)} className='group relative flex items-center justify-center hover:bg-gray-500/20 transition-all duration-300 h-9 w-9 aspect-square rounded-lg cursor-pointer'	>
            ...
            <Image
              src={expand ? "assets/sidebar_close_icon.svg" : "assets/sidebar_icon.svg"}
              alt=""
              width={28}
              height={28}
...
New chat
	  ...
	  {/* CHAT LABEL : STORING ALL THE CHATS*/}
...
<Image  className={expand?"w-5":"w-6.5 mx-auto"} src={expand?"assets/phone_icon.svg":"assets/phone_icon_dull.svg" } alt="" width={28} height={28}/>
	<div className={`absolute -top-60 pb-8 ${!expand && "-right-40"} opacity-0 group-hover:opacity-100 hidden group-hover:block transition`}>

</div>	  {expand && <>
		  <span>Get App</span>
		  <Image src="assets/new_icon.svg"  alt="" width={28} height={28}/>
	...
	<div onClick={user?null:openSignIn}
	  ...
	  {
user?<UserButton/> :	  <Image src="assets/profile_icon.svg" alt="" width={28} height={28}  className='w-7'/>
